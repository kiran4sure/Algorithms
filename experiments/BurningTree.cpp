...
int main()
{
  ...
  root->right->left->left->left = newNode(101);
  root->right->left->left->right = newNode(102);
  root->right->left->left->left->left = newNode(110);
  root->right->left->left->left->right = newNode(111);
	int targetNode = 111;
